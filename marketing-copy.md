...
- *2026-07-04 — Beta-announcement pass: About section on /info/ rewritten by the site owner as a letter — "Dear reader," salutation, first-person creator note in the owner's words, beta note naming the September 17, 2026 full release, signed "D" (`info.mission_salutation/p2/p3/beta/signoff/signature`, en + es; Spanish machine-translated per the 2026-05-14 precedent). New FAQ: "Why is Spanish supported?" answered in the opposite language by owner design — Spanish answer on the English page, English answer on the Spanish page (`info.faq_q7/a7/a7b`; translation source corrected from the owner's draft — the site's ES text is based on State Department/USCIS versions per data/constitution.es.js, not the NCC). Citation FAQ now lists all six formats + the settings shortcut (`info.faq_a6/a6b`); "What is this site?" gains a quality-of-life line (`info.faq_a1b`). Support section "No trackers." swapped to "No cookies." (en + es) — airtight once Cloudflare Web Analytics is enabled, and matches the privacy section's own "cookie-free" wording. README.md added to the public repo using the canonical About statement and GitHub repo description from this file.*
- *2026-05-15 — "Ratified in 1788" framing applied consistently: doc subtitle (en + es) swapped from "inscribed in 1787" to "ratified in 1788." Factual document dates retained (doc.tag "September 17, 1787" signing date; JSON-LD `datePublished` "1787-09-17"). Footer tagline (en + es) updated to the marketing-copy "Footer tagline" line — "The Constitution, line-by-line." (Spanish: "La Constitución, línea por línea."). Share popover rows reordered to copy / email / social (alphabetical) / more, per site owner direction. Twitter clause-share format and "Generic copy-link clause" format intentionally kept as-is (existing format preserves the bluebook citation in the tweet body, matching the share.js design intent — flagged in PR description).*
