...
- *2026-07-04 — Beta-announcement pass: About section on /info/ gains a first-person creator note (`info.mission_p3`, unsigned per site owner direction) and a beta note naming the September 17, 2026 full release (`info.mission_beta`), en + es (Spanish machine-translated per the 2026-05-14 precedent). Support section "No trackers." swapped to "No cookies." (en + es) — airtight once Cloudflare Web Analytics is enabled, and matches the privacy section's own "cookie-free" wording. README.md added to the public repo using the canonical About statement and GitHub repo description from this file.*
