...
module.exports = {
  ...
  "btn.contents_title":       "Contents (Shift+M)",
  "btn.search_aria":          "Search the document",
  "btn.search_title":         "Search (Ctrl/Cmd+F or /)",
  "btn.search_label":         "Search",
  "btn.share":                "Share",
  "btn.share_aria":           "Share",
  "btn.share_title":          "Share (Shift+S)",
  "btn.reader_aria":          "Pure reader mode",
  "btn.reader_title":         "Reader mode (Shift+R)",
  "btn.reader_label":         "Reader",
  "btn.mode_aria":            "Toggle dark mode",
  "btn.mode_title":           "Dark / light (Shift+D)",
  "btn.mode_label":           "Mode",
  "btn.settings_aria":        "Open settings",
  "btn.settings_title":       "Settings (,)",
  "btn.settings_label":       "Settings",
  ...
  "settings.switch_dark_short":"Switch to dark (Shift+D)",
  "settings.switch_oled":     "Switch to OLED",
  "settings.switch_oled_short":"Switch to OLED (Shift+D)",
  "settings.switch_light":    "Switch to light mode",
  "settings.switch_light_short":"Switch to light (Shift+D)",

  // ── Reader mode overlay ──
  "reader.exit_aria":         "Exit reader",
  "reader.exit_label":        "Exit reader",
  "reader.switch_mode_aria":  "Switch mode",
  "reader.switch_mode_title": "Light / Dark / OLED (Shift+D)",
  ...
  "info.mission_salutation":  "Dear reader,",
  ...
  "info.mission_p2":          "Everyone is welcome. This site is built for students, educators, researchers, or anyone else who wants to read the document that defines American governance.",
  "info.mission_p3":          "This site is built and maintained by one person: me. I wanted to make the Constitution a bigger part of American daily life… so I built a version that’s easy to read, cite, or share on any device. It is self-funded and free for everyone.",
  ...
  "info.mission_signoff":     "Sincerely,",
  "info.mission_signature":   "D",
  ...
  "info.faq_a1b":             "Includes modern quality-of-life features such as search, reader mode, light/dark mode support, customizable settings, and keyboard shortcuts.",
  ...
  "info.faq_a6":              "Use the copy button on any paragraph to get a formatted citation in Bluebook, MLA, Chicago, Markdown, BibTeX, or plain text. The citation engine generates the reference automatically.",
  "info.faq_a6b":             "In the reader, use the settings (gear icon or shortcut key [,]) to select your preferred citation style.",
  "info.faq_q7":              "Why is Spanish supported? What about other languages?",
