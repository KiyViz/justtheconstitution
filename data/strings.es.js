...
module.exports = {
  ...
  "btn.contents_title":       "Contenido (Shift+M)",
  "btn.search_aria":          "Buscar en el documento",
  "btn.search_title":         "Buscar (Ctrl/Cmd+F o /)",
  "btn.search_label":         "Buscar",
  "btn.share":                "Compartir",
  "btn.share_aria":           "Compartir",
  "btn.share_title":          "Compartir (Shift+S)",
  "btn.reader_aria":          "Modo de lectura pura",
  "btn.reader_title":         "Modo lectura (Shift+R)",
  "btn.reader_label":         "Lectura",
  "btn.mode_aria":            "Cambiar modo oscuro",
  "btn.mode_title":           "Oscuro / claro (Shift+D)",
  "btn.mode_label":           "Modo",
  "btn.settings_aria":        "Abrir configuración",
  "btn.settings_title":       "Configuración (,)",
  "btn.settings_label":       "Configuración",
  ...
  "settings.switch_dark_short":"Cambiar a oscuro (Shift+D)",
  "settings.switch_oled":     "Cambiar a OLED",
  "settings.switch_oled_short":"Cambiar a OLED (Shift+D)",
  "settings.switch_light":    "Cambiar a modo claro",
  "settings.switch_light_short":"Cambiar a claro (Shift+D)",

  // ── Modo lectura ──
  "reader.exit_aria":         "Salir del modo lectura",
  "reader.exit_label":        "Salir del modo lectura",
  "reader.switch_mode_aria":  "Cambiar modo",
  "reader.switch_mode_title": "Claro / Oscuro / OLED (Shift+D)",
